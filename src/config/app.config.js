...
export const APP_CONFIG = {
  ...
  api: {
    ...
    websocket: {
      ...
      reconnectTimeout: parseInt(import.meta.env.VITE_RECONNECT_TIMEOUT) || 1000,
      connectionTimeout: parseInt(import.meta.env.VITE_CONNECTION_TIMEOUT) || 10000,
      heartbeatInterval: parseInt(import.meta.env.VITE_HEARTBEAT_INTERVAL) || 30000,
    },
  },
  ...
  auth: {
    ...
    oauthUrl: import.meta.env.VITE_DERIV_OAUTH_URL,
